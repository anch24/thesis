            ...
            <header class="topbar">
                <nav class="navbar top-navbar navbar-toggleable-sm navbar-light">
                    ...
                    <div class="navbar-header">
                        <a class="navbar-brand" style="color:white;" href="/instructor">
                            <!-- Logo icon --><b>
                    ...
                    <div class="navbar-collapse">
                        ...
                        <ul class="navbar-nav my-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="material/assets/images/users/1.jpg" alt="user" class="profile-pic m-r-10" />{{ Auth::guard('instructor')->user()->name }}</a>
                            </li>
                        </ul>
                    </div>
                </nav>
            ...
            <aside class="left-sidebar">
                ...
                <div class="scroll-sidebar">
                    ...
                    <nav class="sidebar-nav">
                        <ul id="sidebarnav">
                            <li> <a class="waves-effect waves-dark" href="/instructor" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Dashboard</span></a>
                            </li>
                            <li> <a class="waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-book-plus"></i><span class="hide-menu">Schedules</span></a>
                            </li>
                            <li> <a class="waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-book-open"></i><span class="hide-menu">Classes</span></a>
                            </li>
                            <li> <a class="waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-book-open-page-variant"></i><span class="hide-menu">Subjects Handled</span></a>
                            </li>
                ...
                <div class="sidebar-footer">
                    ...
                    <!-- item--><a href="{{ route('instructor.logout') }}" onclick="event.preventDefault();
