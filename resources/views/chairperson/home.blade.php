            ...
            <header class="topbar">
                <nav class="navbar top-navbar navbar-toggleable-sm navbar-light">
                    ...
                    <div class="navbar-header">
                        <a class="navbar-brand" style="color:white;" href="/chairperson">
                            <!-- Logo icon --><b>
                    ...
                    <div class="navbar-collapse">
                        ...
                        <ul class="navbar-nav my-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="material/assets/images/users/1.jpg" alt="user" class="profile-pic m-r-10" />{{ Auth::guard('chairperson')->user()->name }}</a>
                            </li>
                        </ul>
                    </div>
                </nav>
            ...
            <aside class="left-sidebar">
                ...
                <div class="scroll-sidebar">
                    ...
                    <nav class="sidebar-nav">
                        <ul id="sidebarnav">
                            <li> <a class="waves-effect waves-dark" href="/chairperson" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Dashboard</span></a>
                            </li>
                            <li> <a class="waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-book-plus"></i><span class="hide-menu">Class Schedules</span></a>
                            </li>
                            <li> <a class="waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-account-key"></i><span class="hide-menu">Students Evaluation</span></a>
                            </li>
                ...
                <div class="sidebar-footer">
                    ...
                    <!-- item--><a href="{{ route('chairperson.logout') }}" onclick="event.preventDefault();
                                        document.getElementById('logout-form').submit();" class="link" data-toggle="tooltip" title="Logout"><i class="mdi mdi-power"></i>
                                </a>
                                <form id="logout-form" action="{{ route('chairperson.logout') }}" method="POST" style="display: none;">
                                  @csrf
                                </form>
                </div>
                <!-- End Bottom points-->
                        ...
                        <div class="col-lg-12 col-md-11">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="d-flex flex-wrap">
                                                <div>
                                                    <h3 class="card-title">Evaluation Overview</h3>
                                                    <h6 class="card-subtitle">Total</h6> </div>
                                                <div class="ml-auto">
                                                    <ul class="list-inline">
                                                        <li>
                                                            <h6 class="text-muted text-success"><i class="fa fa-circle font-10 m-r-10 "></i>1st sem</h6> </li>
                                                        <li>
                                                            <h6 class="text-muted  text-info"><i class="fa fa-circle font-10 m-r-10"></i>2nd sem</h6> </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="card">
                                <div class="card-block bg-info">
                                    <h4 class="text-white card-title">Recently Evaluated</h4>
                                    <h6 class="card-subtitle text-white m-b-0 op-5">Checkout your recent evaluation here</h6>
                                </div>
                                <div class="card-block">
                                    <div class="message-box contact-box">
                                        ...
                                        <div class="message-widget contact-widget">
                                            ...
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="material/assets/images/users/2.jpg" alt="user" class="img-circle"> <span class="profile-status busy pull-right"></span> </div>
                                                <div class="mail-contnet">
                                            ...
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="material/assets/images/users/4.jpg" alt="user" class="img-circle"> <span class="profile-status offline pull-right"></span> </div>
                                                <div class="mail-contnet">
